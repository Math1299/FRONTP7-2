...
export default {
    ...
    data() {
        return {
            ...
            valid: true,
            titleRules: [(v) => !!v || "Titre de la publication", (v) => (v && v.length <= 50) || "Le titre doit faire moins de 50 caractères"],
            contentRules: [(v) => !!v || "Ecrivez votre message"],
            comContentRules: [(v) => !!v || "Ecrivez votre commentaire", (v) => (v && v.length <= 255) || "Le commentaire doit faire moins de 255 caractères"],
            dataPost: {
                id: "",
                title: "",
                content: "",
